...
const Media = () => {
  ...
  return (
    <div>
      <div className="media-banner media-banner-text" data-aos="fade-right">
        ...
        <ul class="cards">
          <div  >
            <li>
              <a href="https://twitter.com/auxiun" class="card">
                <img src={SocialMedia} class="card__image" alt="" />
                <div class="card__overlay">
                  <div class="card__header">
                    <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                      <path />
                    </svg>
                    <img class="card__thumb" src={TwitterImage} alt="" />
          ...
          <li>
            <a href="https://telegram.org/" class="card">
              <img src={ChatImage} class="card__image" alt="" />
              <div class="card__overlay">
                <div class="card__header">
                  <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                    <path />
                  </svg>
                  <img class="card__thumb" src={TelegramImage} alt="" />
                  <div class="card__header-text">
          ...
          <li>
            <a
              href="https://www.businessbecause.com/news/entrepreneurs/7655/mba-nft-startup?sponsored"
              class="card"
            >
              <img src={ArticleImage} class="card__image" alt="" />
              <div class="card__overlay">
                <div class="card__header">
                  <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                    <path />
                  </svg>
                  <img class="card__thumb" src={MediumImage} alt="" />
                  <div class="card__header-text">
          ...
          <li>
            <a href="https://www.linkedin.com/company/auxiun/" class="card">
              <img src={LinkedinTeam} class="card__image" alt="" />
              <div class="card__overlay">
                <div class="card__header">
                  <svg class="card__arc" xmlns="http://www.w3.org/2000/svg">
                    <path />
                  </svg>
                  <img class="card__thumb" src={LinkedinImage} alt="" />
                  <div class="card__header-text">
                    <h3 class="card__title">Linkedin</h3>
                    {/* <span class="card__status">3 hours ago</span> */}
                  </div>
                </div>
                <p class="card__description">Checkout our team and company!</p>
              </div>
            </a>
          </li>
        </ul>
